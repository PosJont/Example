...
namespace MES_WORK.Models
{
    ...
    public class MED07_0000
    {
        [Key]
        [DisplayName("識別碼")]
        public int med07_0000 { get; set; }
        ...
        /// 傳入一個DTO，存檔，一次存檔一筆
        /// </summary>
        public void InsertData(MED07_0000 MED07_0000)
        {
            Comm comm = new Comm();
            string sSql = " INSERT INTO " +
                          " MED07_0000 (  mo_code,  wrk_code,  mac_code,  pro_code,  lot_no,  pro_qty,  pro_unit,  loc_code,  ins_date,  ins_time,  usr_code, " +
                          "               des_memo,  is_ng,  is_end,  end_memo,  end_date,  end_time,  end_usr_code , station_code , work_code ,  " +
                          ...
                          "     VALUES ( @mo_code, @wrk_code, @mac_code, @pro_code, @lot_no, @pro_qty, @pro_unit, @loc_code, @ins_date, @ins_time, @usr_code, " +
                          "              @des_memo, @is_ng, @is_end, @end_memo, @end_date, @end_time, @end_usr_code , @station_code , @work_code , " +
                            "             @user_field_01, @user_field_02, @user_field_03, @user_field_04, @user_field_05,    " +
                           "             @user_field_06, @user_field_07, @user_field_08, @user_field_09, @user_field_10 )    ";
            ...
            {
                con_db.Execute(sSql, MED07_0000);
            }
        }
        ...
        /// 傳入一個DTO，修改，一次修改一筆
        /// </summary>
        public void UpdateData(MED07_0000 MED07_0000)
        {
            Comm comm = new Comm();
            string sSql = " UPDATE MED07_0000 " +
                          "    SET mo_code       =  @mo_code,       " +
                          "        wrk_code      =  @wrk_code,      " +
                          "        work_code     =  @work_code,      " +
