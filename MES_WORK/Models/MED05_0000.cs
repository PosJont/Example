...
{
    public class MED05_0000
    {
        [Key]
        [DisplayName("識別碼")]
        public int med05_0000 { get; set; }
        ...
        public void InsertData(MED05_0000 MED05_0000)
        {
            ...
            string sSql = " INSERT INTO " +
                          " MED05_0000 (  mo_code,  wrk_code,  mac_code,  except_code,  date_s,  time_s,  date_e,  time_e,  ins_date,  ins_time,  usr_code, " +
                          "               des_memo,  is_ng,  is_end,  end_memo,  end_date,  end_time,  end_usr_code ) " +

                          "     VALUES ( @mo_code, @wrk_code, @mac_code, @except_code, @date_s, @time_s, @date_e, @time_e, @ins_date, @ins_time, @usr_code, " +
                          "              @des_memo, @is_ng, @is_end, @end_memo, @end_date, @end_time, @end_usr_code ) ";
