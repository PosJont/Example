...
{
    public class MIX010AController : Controller
    {
        Comm comm = new Comm();
        Work iWork = new Work();
        ...
        public ActionResult Index()
        {
            ...
            ViewData["sku_code"] = "sku_code";//ViewBag.wrk_code;
            ViewData["amount_value"] = "amount_value"; //ViewBag.pro_code;
            ViewData["item_no"] = "item_no";// ViewBag.pro_name;
            ViewData["item_lot_no"] = "item_lot_no";  //ViewBag.mo_qty;
            ViewData["res_qty"] = "res_qty"; //ViewBag.res_qty;
        ...
        public ActionResult Index(FormCollection form)
        {
            ...
            string sMoCode = iWork.Get_MoCodeByMacCode(sMacCode);
            string sWrkCode = iWork.Get_WrkCodeByMacCode(sMacCode);
            string pro_qty = "1"; //comm.sGetString(form["pro_qty"].ToString());
            string pro_lot_no = "123";// comm.sGetString(form["lot_no"].ToString());
            ...
            //med09_0000.user_field_01 = form["user_field_01"];
            //med09_0000.user_field_02 = form["user_field_02"];
            //med09_0000.user_field_03 = form["user_field_03"];
            //med09_0000.user_field_04 = form["user_field_04"];
            //med09_0000.user_field_05 = form["user_field_05"];
            //med09_0000.user_field_06 = form["user_field_06"];
            //med09_0000.user_field_07 = form["user_field_07"];
            //med09_0000.user_field_08 = form["user_field_08"];
            //med09_0000.user_field_09 = form["user_field_09"];
            //med09_0000.user_field_10 = form["user_field_10"];
            //if (form["user_field_01"] == null) med09_0000.user_field_01 = "";
            //if (form["user_field_02"] == null) med09_0000.user_field_02 = "";
            //if (form["user_field_03"] == null) med09_0000.user_field_03 = "";
            //if (form["user_field_04"] == null) med09_0000.user_field_04 = "";
            //if (form["user_field_05"] == null) med09_0000.user_field_05 = "";
            //if (form["user_field_06"] == null) med09_0000.user_field_06 = "";
            //if (form["user_field_07"] == null) med09_0000.user_field_07 = "";
            //if (form["user_field_08"] == null) med09_0000.user_field_08 = "";
            //if (form["user_field_09"] == null) med09_0000.user_field_09 = "";
            //if (form["user_field_10"] == null) med09_0000.user_field_10 = "";
